...
//        System.out.println("Email: " + cliente.getEmail() + "\nSenha: " + cliente.getSenha());
        if (email.getText().equals("") || senha.getText().equals("") || nome.getText().equals("") || cpf.getText().equals("")) {

            JOptionPane.showMessageDialog(null, "Campos Obrigatórios! ");

        } else if (!email.getText().isEmpty()) {
            boolean isEmailValido = RegexUtils.isEmail(email.getText());
       ...
       }catch(Exception e1){JOptionPane.showMessageDialog(null, "Sem Conexào com o Servidor!");} 
        }
